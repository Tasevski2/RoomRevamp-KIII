...
<body class="font-sans text-gray-900 antialiased" style="background-color: #2f2f2f;">

    <!-- LOGO START-->
    <div>
        <a href="{{ $frontendUrl }}">
            <svg width="250px" height="187.5px" style="margin-bottom: 30px;" viewBox="0 0 350 283.277">
                <defs>
                    <linearGradient id="a">
                ...
                <path
                    ...
                    transform="translate(-2.246 239.243) scale(2.2017)" fill="url(#b)" />
            </svg>
        </a>
    </div>
    <!-- LOGO END -->
    <div class="container">
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('password.update') }}" style="text-align: center;">
                @csrf
                ...
                <div class="row">
                    ...
                    <input id="email" class="input" type="email" name="email" value="{{ $email }}" required />
                </div>
